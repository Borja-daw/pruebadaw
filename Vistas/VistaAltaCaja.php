        ...
        <div class="wrapper">
            ...
            <div id="content">
                <nav class="navbar navbar-expand-lg tit">
                    <button type="button" id="sidebarCollapse" class="btn btn-infolg">
                ...
                <form name="altaCajas" action="../Controladores/AltaCaja.php" method="POST">
                    <div class="form-row justify-content-center">
                        <div class="form-group col-md-2">
                            <label for="codigo"></label>
                            <input type="text" class="form-control" name="codigo_caja" placeholder="Código">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="material"></label>
                            <input type="text" class="form-control" name="material_caja" placeholder="Material">
                        </div>
                    </div>
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-md-1">
                            ...
                            <input type="number" class="form-control" name="anchura" placeholder="Anchura">
                        </div>
                        <div class="form-group col-md-1">
                            <label for="profundidad"></label>
                            <input type="number" class="form-control" name="profundidad" placeholder="Profundo">
                        </div>
                        <div class="form-group col-md-1">
                            Color<input type="color" class="form-control" name="color" placeholder="Color">
                        </div>
                    </div>
                    <div class="form-row justify-content-center">
