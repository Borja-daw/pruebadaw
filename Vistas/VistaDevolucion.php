...
<html lang="en">
    ...
    <body>
        <?php
        session_start();
        $arrayCajasLibres = $_SESSION['Cajas'];
        ?>
        <div class="wrapper">
            <!-- Sidebar  -->
            <nav id="sidebar">
            ...
            <div id="content">
                ...
                <form name="elegirCajas" action="../Controladores/MostrarCajaDevol.php" method="POST">
                    <div class="form-row justify-content-center">
                        <div class="form-group col-md-4">
                            <select class="form-control " name="caja">
                                <option values="nulo" selected="selected">Elije Caja</option>
                                <?php foreach ($arrayCajasLibres as $Caja) { ?>
                                    <option value="<?php echo $Caja->codigo_caja ?>">
