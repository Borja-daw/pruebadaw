...
<html lang="en">
    ...
    <body class="text-center">
        ...
        <form class="form-signin" name="registro" action="../Controladores/Registro.php" method="POST">
            ...
            <input type="password" name="pass" id="Contraseña" class="form-control" placeholder="Contraseña" required>
            <br>
